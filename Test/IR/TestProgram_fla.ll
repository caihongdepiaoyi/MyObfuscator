...
define dso_local void @_Z7encryptPhPc(i8* %0, i8* %1) #0 {
  ...
  store i32 198820185, i32* %swVar.ptr, align 4
  br label %dispatchBB

dispatchBB:                                       ; preds = %2, %returnBB
  %swVar = load i32, i32* %swVar.ptr, align 4
  switch i32 %swVar, label %swDefault [
    i32 198820185, label %7
    i32 1118858259, label %10
    i32 2078081897, label %12
    i32 1782232299, label %15
    i32 1570915601, label %18
    i32 1669108895, label %25
    i32 1837777233, label %32
    i32 647696323, label %37
    i32 227377429, label %40
    i32 1909149567, label %41
  ]
...
7:                                                ; preds = %dispatchBB
  ...
  store i32 1118858259, i32* %swVar.ptr, align 4
  br label %returnBB
...
10:                                               ; preds = %dispatchBB
  ...
  store i32 2078081897, i32* %swVar.ptr, align 4
  br label %returnBB
...
12:                                               ; preds = %dispatchBB
  ...
  store i32 1782232299, i32* %swVar.ptr, align 4
  br label %returnBB
...
15:                                               ; preds = %dispatchBB
  ...
  %17 = select i1 %16, i32 1570915601, i32 1909149567
...
18:                                               ; preds = %dispatchBB
  ...
  store i32 1669108895, i32* %swVar.ptr, align 4
  br label %returnBB
...
25:                                               ; preds = %dispatchBB
  ...
  store i32 1837777233, i32* %swVar.ptr, align 4
  br label %returnBB
...
32:                                               ; preds = %dispatchBB
  ...
  store i32 647696323, i32* %swVar.ptr, align 4
  br label %returnBB
...
37:                                               ; preds = %dispatchBB
  ...
  store i32 227377429, i32* %swVar.ptr, align 4
  br label %returnBB
...
define dso_local i32 @main(i32 %0, i8** %1) #2 {
  ...
  %swVar.ptr = alloca i32, align 4
  store i32 513610446, i32* %swVar.ptr, align 4
...
dispatchBB:                                       ; preds = %2, %returnBB
  %swVar = load i32, i32* %swVar.ptr, align 4
  switch i32 %swVar, label %swDefault [
    i32 513610446, label %7
    i32 2140432813, label %9
    i32 1092312839, label %14
    i32 1666293455, label %16
    i32 336129648, label %17
    i32 1799464498, label %18
    i32 183443193, label %23
    i32 149304408, label %28
    i32 1837394738, label %33
    i32 1802745712, label %36
    i32 367862649, label %39
    i32 486298077, label %40
    i32 1078328399, label %45
    i32 1405470285, label %47
    i32 1016912255, label %48
    i32 1871947542, label %50
    i32 673823836, label %51
    i32 810766097, label %53
  ]
...
7:                                                ; preds = %dispatchBB
  ...
  store i32 2140432813, i32* %swVar.ptr, align 4
  br label %returnBB
...
9:                                                ; preds = %dispatchBB
  ...
  %13 = select i1 %12, i32 1092312839, i32 1799464498
  store i32 %13, i32* %swVar.ptr, align 4
  br label %returnBB

14:                                               ; preds = %dispatchBB
  %15 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.1, i64 0, i64 0))
  store i32 1666293455, i32* %swVar.ptr, align 4
  br label %returnBB

16:                                               ; preds = %dispatchBB
  store i32 0, i32* %3, align 4
  store i32 336129648, i32* %swVar.ptr, align 4
  br label %returnBB

17:                                               ; preds = %dispatchBB
  store i32 673823836, i32* %swVar.ptr, align 4
  br label %returnBB
...
18:                                               ; preds = %dispatchBB
  ...
  store i32 183443193, i32* %swVar.ptr, align 4
  br label %returnBB
...
23:                                               ; preds = %dispatchBB
  ...
  store i32 149304408, i32* %swVar.ptr, align 4
  br label %returnBB
...
28:                                               ; preds = %dispatchBB
  ...
  %32 = select i1 %31, i32 1837394738, i32 486298077
...
33:                                               ; preds = %dispatchBB
  ...
  store i32 1802745712, i32* %swVar.ptr, align 4
  br label %returnBB
...
36:                                               ; preds = %dispatchBB
  ...
  store i32 367862649, i32* %swVar.ptr, align 4
  br label %returnBB

39:                                               ; preds = %dispatchBB
  store i32 486298077, i32* %swVar.ptr, align 4
...
48:                                               ; preds = %dispatchBB
  ...
  store i32 1871947542, i32* %swVar.ptr, align 4
  br label %returnBB
...
51:                                               ; preds = %dispatchBB
  ...
  store i32 810766097, i32* %swVar.ptr, align 4
  br label %returnBB
