...
define dso_local void @_Z7encryptPhPc(i8* %0, i8* %1) #0 {
  ...
  store i32 603498861, i32* %swVar.ptr, align 4
  br label %dispatchBB

dispatchBB:                                       ; preds = %2, %returnBB
  %swVar = load i32, i32* %swVar.ptr, align 4
  switch i32 %swVar, label %swDefault [
    i32 603498861, label %7
    i32 830679305, label %10
    i32 1399430077, label %12
    i32 1818521672, label %15
    i32 1364813672, label %18
    i32 1891178212, label %25
    i32 575484603, label %32
    i32 696437728, label %37
    i32 1428527394, label %40
    i32 1788956355, label %41
  ]
...
7:                                                ; preds = %dispatchBB
  ...
  store i32 830679305, i32* %swVar.ptr, align 4
  br label %returnBB
...
10:                                               ; preds = %dispatchBB
  ...
  store i32 1399430077, i32* %swVar.ptr, align 4
  br label %returnBB
...
12:                                               ; preds = %dispatchBB
  ...
  store i32 1818521672, i32* %swVar.ptr, align 4
  br label %returnBB
...
15:                                               ; preds = %dispatchBB
  ...
  %17 = select i1 %16, i32 1364813672, i32 1788956355
...
18:                                               ; preds = %dispatchBB
  ...
  store i32 1891178212, i32* %swVar.ptr, align 4
  br label %returnBB
...
25:                                               ; preds = %dispatchBB
  ...
  store i32 575484603, i32* %swVar.ptr, align 4
  br label %returnBB
...
32:                                               ; preds = %dispatchBB
  ...
  store i32 696437728, i32* %swVar.ptr, align 4
  br label %returnBB
...
37:                                               ; preds = %dispatchBB
  ...
  store i32 1428527394, i32* %swVar.ptr, align 4
  br label %returnBB
...
define dso_local i32 @main(i32 %0, i8** %1) #2 {
  ...
  %swVar.ptr = alloca i32, align 4
  store i32 620632299, i32* %swVar.ptr, align 4
...
dispatchBB:                                       ; preds = %2, %returnBB
  %swVar = load i32, i32* %swVar.ptr, align 4
  switch i32 %swVar, label %swDefault [
    i32 620632299, label %7
    i32 1581528069, label %9
    i32 1179047632, label %14
    i32 870963222, label %16
    i32 871493860, label %17
    i32 1384705089, label %18
    i32 2122497660, label %23
    i32 1351063446, label %28
    i32 1505358387, label %33
    i32 820969379, label %36
    i32 1983322320, label %39
    i32 2096877904, label %40
    i32 1245960035, label %45
    i32 980468380, label %47
    i32 1171412258, label %48
    i32 1174944245, label %50
    i32 1117920892, label %51
    i32 1146036691, label %53
  ]
...
7:                                                ; preds = %dispatchBB
  ...
  store i32 1581528069, i32* %swVar.ptr, align 4
  br label %returnBB
...
9:                                                ; preds = %dispatchBB
  ...
  %13 = select i1 %12, i32 1179047632, i32 1384705089
  store i32 %13, i32* %swVar.ptr, align 4
  br label %returnBB

14:                                               ; preds = %dispatchBB
  %15 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.1, i64 0, i64 0))
  store i32 870963222, i32* %swVar.ptr, align 4
  br label %returnBB

16:                                               ; preds = %dispatchBB
  store i32 0, i32* %3, align 4
  store i32 871493860, i32* %swVar.ptr, align 4
  br label %returnBB

17:                                               ; preds = %dispatchBB
  store i32 1117920892, i32* %swVar.ptr, align 4
  br label %returnBB
...
18:                                               ; preds = %dispatchBB
  ...
  store i32 2122497660, i32* %swVar.ptr, align 4
  br label %returnBB
...
23:                                               ; preds = %dispatchBB
  ...
  store i32 1351063446, i32* %swVar.ptr, align 4
  br label %returnBB
...
28:                                               ; preds = %dispatchBB
  ...
  %32 = select i1 %31, i32 1505358387, i32 2096877904
...
33:                                               ; preds = %dispatchBB
  ...
  store i32 820969379, i32* %swVar.ptr, align 4
  br label %returnBB
...
36:                                               ; preds = %dispatchBB
  ...
  store i32 1983322320, i32* %swVar.ptr, align 4
  br label %returnBB

39:                                               ; preds = %dispatchBB
  store i32 2096877904, i32* %swVar.ptr, align 4
...
48:                                               ; preds = %dispatchBB
  ...
  store i32 1174944245, i32* %swVar.ptr, align 4
  br label %returnBB
...
51:                                               ; preds = %dispatchBB
  ...
  store i32 1146036691, i32* %swVar.ptr, align 4
  br label %returnBB
