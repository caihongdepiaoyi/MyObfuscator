; ModuleID = 'TestProgram/bc/__main_argc_argv.bc'
source_filename = "TestProgram.cpp"
target datalayout = "e-m:e-p:32:32-i64:64-n32:64-S128-ni:1:10:20"
target triple = "wasm32-unknown-wasi"

@input = external hidden global i8*, align 4
@enc = external hidden global <{ [22 x i8], [78 x i8] }>, align 16
...
bodyBB18:                                         ; preds = %bodyBB18cloneBB, %24
  ...
  %33 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str, i32 0, i32 0))
...
bodyBB26:                                         ; preds = %bodyBB26cloneBB, %44
  %53 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.1, i32 0, i32 0))
...
bodyBB38:                                         ; preds = %bodyBB38cloneBB, %79
  ...
  %92 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.2, i32 0, i32 0), i8* %91)
...
bodyBB76:                                         ; preds = %bodyBB76cloneBB, %183
  %192 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.3, i32 0, i32 0))
...
bodyBB88:                                         ; preds = %bodyBB88cloneBB, %218
  %227 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.4, i32 0, i32 0))
...
bodyBB18cloneBB:                                  ; preds = %bodyBB18, %24
  ...
  %293 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str, i32 0, i32 0))
...
bodyBB26cloneBB:                                  ; preds = %bodyBB26, %44
  %296 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.1, i32 0, i32 0))
...
bodyBB38cloneBB:                                  ; preds = %bodyBB38, %79
  ...
  %301 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.2, i32 0, i32 0), i8* %300)
...
bodyBB76cloneBB:                                  ; preds = %bodyBB76, %183
  %315 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.3, i32 0, i32 0))
  br label %bodyBB76
...
bodyBB88cloneBB:                                  ; preds = %bodyBB88, %218
  %316 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.4, i32 0, i32 0))
  br label %bodyBB88
...
attributes #2 = { mustprogress noinline norecurse optnone "frame-pointer"="none" "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="generic" }
